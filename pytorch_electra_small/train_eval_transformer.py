...
from transformers import AdamW,get_linear_schedule_with_warmup, ElectraTokenizer, ElectraForSequenceClassification
...
def test(config, test_iter):
    # test
    model = ElectraForSequenceClassification.from_pretrained(config.saved_finetuning_path)
